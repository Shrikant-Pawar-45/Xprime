...
*/var Cs,z1;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(M,I){function N(){}N.prototype=I.prototype,M.D=I.prototype,M.prototype=new N,M.prototype.constructor=M,M.C=function(k,V,F){for(var O=Array(arguments.length-2),en=2;en<arguments.length;en++)O[en-2]=arguments[en];return I.prototype[V].apply(k,O)}}function t(){this.blockSize=-1}function i(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(i,t),i.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function a(M,I,N){N||(N=0);var k=Array(16);if(typeof I=="string")for(var V=0;16>V;++V)k[V]=I.charCodeAt(N++)|I.charCodeAt(N++)<<8|I.charCodeAt(N++)<<16|I.charCodeAt(N++)<<24;else for(V=0;16>V;++V)k[V]=I[N++]|I[N++]<<8|I[N++]<<16|I[N++]<<24;I=M.g[0],N=M.g[1],V=M.g[2];var F=M.g[3],O=I+(F^N&(V^F))+k[0]+3614090360&4294967295;I=N+(O<<7&4294967295|O>>>25),O=F+(V^I&(N^V))+k[1]+3905402710&4294967295,F=I+(O<<12&4294967295|O>>>20),O=V+(N^F&(I^N))+k[2]+606105819&4294967295,V=F+(O<<17&4294967295|O>>>15),O=N+(I^V&(F^I))+k[3]+3250441966&4294967295,N=V+(O<<22&4294967295|O>>>10),O=I+(F^N&(V^F))+k[4]+4118548399&4294967295,I=N+(O<<7&4294967295|O>>>25),O=F+(V^I&(N^V))+k[5]+1200080426&4294967295,F=I+(O<<12&4294967295|O>>>20),O=V+(N^F&(I^N))+k[6]+2821735955&4294967295,V=F+(O<<17&4294967295|O>>>15),O=N+(I^V&(F^I))+k[7]+4249261313&4294967295,N=V+(O<<22&4294967295|O>>>10),O=I+(F^N&(V^F))+k[8]+1770035416&4294967295,I=N+(O<<7&4294967295|O>>>25),O=F+(V^I&(N^V))+k[9]+2336552879&4294967295,F=I+(O<<12&4294967295|O>>>20),O=V+(N^F&(I^N))+k[10]+4294925233&4294967295,V=F+(O<<17&4294967295|O>>>15),O=N+(I^V&(F^I))+k[11]+2304563134&4294967295,N=V+(O<<22&4294967295|O>>>10),O=I+(F^N&(V^F))+k[12]+1804603682&4294967295,I=N+(O<<7&4294967295|O>>>25),O=F+(V^I&(N^V))+k[13]+4254626195&4294967295,F=I+(O<<12&4294967295|O>>>20),O=V+(N^F&(I^N))+k[14]+2792965006&4294967295,V=F+(O<<17&4294967295|O>>>15),O=N+(I^V&(F^I))+k[15]+1236535329&4294967295,N=V+(O<<22&4294967295|O>>>10),O=I+(V^F&(N^V))+k[1]+4129170786&4294967295,I=N+(O<<5&4294967295|O>>>27),O=F+(N^V&(I^N))+k[6]+3225465664&4294967295,F=I+(O<<9&4294967295|O>>>23),O=V+(I^N&(F^I))+k[11]+643717713&4294967295,V=F+(O<<14&4294967295|O>>>18),O=N+(F^I&(V^F))+k[0]+3921069994&4294967295,N=V+(O<<20&4294967295|O>>>12),O=I+(V^F&(N^V))+k[5]+3593408605&4294967295,I=N+(O<<5&4294967295|O>>>27),O=F+(N^V&(I^N))+k[10]+38016083&4294967295,F=I+(O<<9&4294967295|O>>>23),O=V+(I^N&(F^I))+k[15]+3634488961&4294967295,V=F+(O<<14&4294967295|O>>>18),O=N+(F^I&(V^F))+k[4]+3889429448&4294967295,N=V+(O<<20&4294967295|O>>>12),O=I+(V^F&(N^V))+k[9]+568446438&4294967295,I=N+(O<<5&4294967295|O>>>27),O=F+(N^V&(I^N))+k[14]+3275163606&4294967295,F=I+(O<<9&4294967295|O>>>23),O=V+(I^N&(F^I))+k[3]+4107603335&4294967295,V=F+(O<<14&4294967295|O>>>18),O=N+(F^I&(V^F))+k[8]+1163531501&4294967295,N=V+(O<<20&4294967295|O>>>12),O=I+(V^F&(N^V))+k[13]+2850285829&4294967295,I=N+(O<<5&4294967295|O>>>27),O=F+(N^V&(I^N))+k[2]+4243563512&4294967295,F=I+(O<<9&4294967295|O>>>23),O=V+(I^N&(F^I))+k[7]+1735328473&4294967295,V=F+(O<<14&4294967295|O>>>18),O=N+(F^I&(V^F))+k[12]+2368359562&4294967295,N=V+(O<<20&4294967295|O>>>12),O=I+(N^V^F)+k[5]+4294588738&4294967295,I=N+(O<<4&4294967295|O>>>28),O=F+(I^N^V)+k[8]+2272392833&4294967295,F=I+(O<<11&4294967295|O>>>21),O=V+(F^I^N)+k[11]+1839030562&4294967295,V=F+(O<<16&4294967295|O>>>16),O=N+(V^F^I)+k[14]+4259657740&4294967295,N=V+(O<<23&4294967295|O>>>9),O=I+(N^V^F)+k[1]+2763975236&4294967295,I=N+(O<<4&4294967295|O>>>28),O=F+(I^N^V)+k[4]+1272893353&4294967295,F=I+(O<<11&4294967295|O>>>21),O=V+(F^I^N)+k[7]+4139469664&4294967295,V=F+(O<<16&4294967295|O>>>16),O=N+(V^F^I)+k[10]+3200236656&4294967295,N=V+(O<<23&4294967295|O>>>9),O=I+(N^V^F)+k[13]+681279174&4294967295,I=N+(O<<4&4294967295|O>>>28),O=F+(I^N^V)+k[0]+3936430074&4294967295,F=I+(O<<11&4294967295|O>>>21),O=V+(F^I^N)+k[3]+3572445317&4294967295,V=F+(O<<16&4294967295|O>>>16),O=N+(V^F^I)+k[6]+76029189&4294967295,N=V+(O<<23&4294967295|O>>>9),O=I+(N^V^F)+k[9]+3654602809&4294967295,I=N+(O<<4&4294967295|O>>>28),O=F+(I^N^V)+k[12]+3873151461&4294967295,F=I+(O<<11&4294967295|O>>>21),O=V+(F^I^N)+k[15]+530742520&4294967295,V=F+(O<<16&4294967295|O>>>16),O=N+(V^F^I)+k[2]+3299628645&4294967295,N=V+(O<<23&4294967295|O>>>9),O=I+(V^(N|~F))+k[0]+4096336452&4294967295,I=N+(O<<6&4294967295|O>>>26),O=F+(N^(I|~V))+k[7]+1126891415&4294967295,F=I+(O<<10&4294967295|O>>>22),O=V+(I^(F|~N))+k[14]+2878612391&4294967295,V=F+(O<<15&4294967295|O>>>17),O=N+(F^(V|~I))+k[5]+4237533241&4294967295,N=V+(O<<21&4294967295|O>>>11),O=I+(V^(N|~F))+k[12]+1700485571&4294967295,I=N+(O<<6&4294967295|O>>>26),O=F+(N^(I|~V))+k[3]+2399980690&4294967295,F=I+(O<<10&4294967295|O>>>22),O=V+(I^(F|~N))+k[10]+4293915773&4294967295,V=F+(O<<15&4294967295|O>>>17),O=N+(F^(V|~I))+k[1]+2240044497&4294967295,N=V+(O<<21&4294967295|O>>>11),O=I+(V^(N|~F))+k[8]+1873313359&4294967295,I=N+(O<<6&4294967295|O>>>26),O=F+(N^(I|~V))+k[15]+4264355552&4294967295,F=I+(O<<10&4294967295|O>>>22),O=V+(I^(F|~N))+k[6]+2734768916&4294967295,V=F+(O<<15&4294967295|O>>>17),O=N+(F^(V|~I))+k[13]+1309151649&4294967295,N=V+(O<<21&4294967295|O>>>11),O=I+(V^(N|~F))+k[4]+4149444226&4294967295,I=N+(O<<6&4294967295|O>>>26),O=F+(N^(I|~V))+k[11]+3174756917&4294967295,F=I+(O<<10&4294967295|O>>>22),O=V+(I^(F|~N))+k[2]+718787259&4294967295,V=F+(O<<15&4294967295|O>>>17),O=N+(F^(V|~I))+k[9]+3951481745&4294967295,M.g[0]=M.g[0]+I&4294967295,M.g[1]=M.g[1]+(V+(O<<21&4294967295|O>>>11))&4294967295,M.g[2]=M.g[2]+V&4294967295,M.g[3]=M.g[3]+F&4294967295}i.prototype.u=function(M,I){I===void 0&&(I=M.length);for(var N=I-this.blockSize,k=this.B,V=this.h,F=0;F<I;){if(V==0)for(;F<=N;)a(this,M,F),F+=this.blockSize;if(typeof M=="string"){for(;F<I;)if(k[V++]=M.charCodeAt(F++),V==this.blockSize){a(this,k),V=0;break}}else for(;F<I;)if(k[V++]=M[F++],V==this.blockSize){a(this,k),V=0;break}}this.h=V,this.o+=I},i.prototype.v=function(){var M=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);M[0]=128;for(var I=1;I<M.length-8;++I)M[I]=0;var N=8*this.o;for(I=M.length-8;I<M.length;++I)M[I]=N&255,N/=256;for(this.u(M),M=Array(16),I=N=0;4>I;++I)for(var k=0;32>k;k+=8)M[N++]=this.g[I]>>>k&255;return M};function l(M,I){var N=d;return Object.prototype.hasOwnProperty.call(N,M)?N[M]:N[M]=I(M)}function u(M,I){this.h=I;for(var N=[],k=!0,V=M.length-1;0<=V;V--){var F=M[V]|0;k&&F==I||(N[V]=F,k=!1)}this.g=N}var d={};function p(M){return-128<=M&&128>M?l(M,function(I){return new u([I|0],0>I?-1:0)}):new u([M|0],0>M?-1:0)}function m(M){if(isNaN(M)||!isFinite(M))return E;if(0>M)return j(m(-M));for(var I=[],N=1,k=0;M>=N;k++)I[k]=M/N|0,N*=4294967296;return new u(I,0)}function y(M,I){if(M.length==0)throw Error("number format error: empty string");if(I=I||10,2>I||36<I)throw Error("radix out of range: "+I);if(M.charAt(0)=="-")return j(y(M.substring(1),I));if(0<=M.indexOf("-"))throw Error('number format error: interior "-" character');for(var N=m(Math.pow(I,8)),k=E,V=0;V<M.length;V+=8){var F=Math.min(8,M.length-V),O=parseInt(M.substring(V,V+F),I);8>F?(F=m(Math.pow(I,F)),k=k.j(F).add(m(O))):(k=k.j(N),k=k.add(m(O)))}return k}var E=p(0),w=p(1),R=p(16777216);n=u.prototype,n.m=function(){if(B(this))return-j(this).m();for(var M=0,I=1,N=0;N<this.g.length;N++){var k=this.i(N);M+=(0<=k?k:4294967296+k)*I,I*=4294967296}return M},n.toString=function(M){if(M=M||10,2>M||36<M)throw Error("radix out of range: "+M);if(C(this))return"0";if(B(this))return"-"+j(this).toString(M);for(var I=m(Math.pow(M,6)),N=this,k="";;){var V=re(N,I).g;N=$(N,V.j(I));var F=((0<N.g.length?N.g[0]:N.h)>>>0).toString(M);if(N=V,C(N))return F+k;for(;6>F.length;)F="0"+F;k=F+k}},n.i=function(M){return 0>M?0:M<this.g.length?this.g[M]:this.h};function C(M){if(M.h!=0)return!1;for(var I=0;I<M.g.length;I++)if(M.g[I]!=0)return!1;return!0}function B(M){return M.h==-1}n.l=function(M){return M=$(this,M),B(M)?-1:C(M)?0:1};function j(M){for(var I=M.g.length,N=[],k=0;k<I;k++)N[k]=~M.g[k];return new u(N,~M.h).add(w)}n.abs=function(){return B(this)?j(this):this},n.add=function(M){for(var I=Math.max(this.g.length,M.g.length),N=[],k=0,V=0;V<=I;V++){var F=k+(this.i(V)&65535)+(M.i(V)&65535),O=(F>>>16)+(this.i(V)>>>16)+(M.i(V)>>>16);k=O>>>16,F&=65535,O&=65535,N[V]=O<<16|F}return new u(N,N[N.length-1]&-2147483648?-1:0)};function $(M,I){return M.add(j(I))}n.j=function(M){if(C(this)||C(M))return E;if(B(this))return B(M)?j(this).j(j(M)):j(j(this).j(M));if(B(M))return j(this.j(j(M)));if(0>this.l(R)&&0>M.l(R))return m(this.m()*M.m());for(var I=this.g.length+M.g.length,N=[],k=0;k<2*I;k++)N[k]=0;for(k=0;k<this.g.length;k++)for(var V=0;V<M.g.length;V++){var F=this.i(k)>>>16,O=this.i(k)&65535,en=M.i(V)>>>16,_t=M.i(V)&65535;N[2*k+2*V]+=O*_t,K(N,2*k+2*V),N[2*k+2*V+1]+=F*_t,K(N,2*k+2*V+1),N[2*k+2*V+1]+=O*en,K(N,2*k+2*V+1),N[2*k+2*V+2]+=F*en,K(N,2*k+2*V+2)}for(k=0;k<I;k++)N[k]=N[2*k+1]<<16|N[2*k];for(k=I;k<2*I;k++)N[k]=0;return new u(N,0)};function K(M,I){for(;(M[I]&65535)!=M[I];)M[I+1]+=M[I]>>>16,M[I]&=65535,I++}function te(M,I){this.g=M,this.h=I}function re(M,I){if(C(I))throw Error("division by zero");if(C(M))return new te(E,E);if(B(M))return I=re(j(M),I),new te(j(I.g),j(I.h));if(B(I))return I=re(M,j(I)),new te(j(I.g),I.h);if(30<M.g.length){if(B(M)||B(I))throw Error("slowDivide_ only works with positive integers.");for(var N=w,k=I;0>=k.l(M);)N=ce(N),k=ce(k);var V=ve(N,1),F=ve(k,1);for(k=ve(k,2),N=ve(N,2);!C(k);){var O=F.add(k);0>=O.l(M)&&(V=V.add(N),F=O),k=ve(k,1),N=ve(N,1)}return I=$(M,V.j(I)),new te(V,I)}for(V=E;0<=M.l(I);){for(N=Math.max(1,Math.floor(M.m()/I.m())),k=Math.ceil(Math.log(N)/Math.LN2),k=48>=k?1:Math.pow(2,k-48),F=m(N),O=F.j(I);B(O)||0<O.l(M);)N-=k,F=m(N),O=F.j(I);C(F)&&(F=w),V=V.add(F),M=$(M,O)}return new te(V,M)}n.A=function(M){return re(this,M).h},n.and=function(M){for(var I=Math.max(this.g.length,M.g.length),N=[],k=0;k<I;k++)N[k]=this.i(k)&M.i(k);return new u(N,this.h&M.h)},n.or=function(M){for(var I=Math.max(this.g.length,M.g.length),N=[],k=0;k<I;k++)N[k]=this.i(k)|M.i(k);return new u(N,this.h|M.h)},n.xor=function(M){for(var I=Math.max(this.g.length,M.g.length),N=[],k=0;k<I;k++)N[k]=this.i(k)^M.i(k);return new u(N,this.h^M.h)};function ce(M){for(var I=M.g.length+1,N=[],k=0;k<I;k++)N[k]=M.i(k)<<1|M.i(k-1)>>>31;return new u(N,M.h)}function ve(M,I){var N=I>>5;I%=32;for(var k=M.g.length-N,V=[],F=0;F<k;F++)V[F]=0<I?M.i(F+N)>>>I|M.i(F+N+1)<<32-I:M.i(F+N);return new u(V,M.h)}i.prototype.digest=i.prototype.v,i.prototype.reset=i.prototype.s,i.prototype.update=i.prototype.u,z1=i,u.prototype.add=u.prototype.add,u.prototype.multiply=u.prototype.j,u.prototype.modulo=u.prototype.A,u.prototype.compare=u.prototype.l,u.prototype.toNumber=u.prototype.m,u.prototype.toString=u.prototype.toString,u.prototype.getBits=u.prototype.i,u.fromNumber=m,u.fromString=y,Cs=u}).apply(typeof Nw<"u"?Nw:typeof self<"u"?self:typeof window<"u"?window:{});var bd=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Nf;function zU(n){oe(!Nf,"__referenceConstructor has already been defined"),Nf=n}function BU(){return oe(Nf,"Reference.ts has not been loaded"),Nf}let HU=1;class cS{constructor(e){this.listenProvider_=e,this.syncPointTree_=new ut(null),this.pendingWriteTree_=yU(),this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function WI(n,e,t,i,a){return oU(n.pendingWriteTree_,e,t,i,a),a?Yc(n,new Ha(OI(),e,t)):[]}function Pa(n,e,t=!1){const i=lU(n.pendingWriteTree_,e);if(uU(n.pendingWriteTree_,e)){let l=new ut(null);return i.snap!=null?l=l.set(We(),!0):On(i.children,u=>{l=l.set(new st(u),!0)}),Yc(n,new bf(i.path,l,t))}else return[]}function Wc(n,e,t){return Yc(n,new Ha(tv(),e,t))}function qU(n,e,t){const i=ut.fromObject(t);return Yc(n,new Rc(tv(),e,i))}function GU(n,e){return Yc(n,new Ac(tv(),e))}function WU(n,e,t){const i=lv(n,t);if(i){const a=uv(i),l=a.path,u=a.queryId,d=bn(l,e),p=new Ac(nv(u),d);return cv(n,l,p)}else return[]}function YI(n,e,t,i,a=!1){const l=e._path,u=n.syncPointTree_.get(l);let d=[];if(u&&(e._queryIdentifier==="default"||GI(u,e))){const p=FU(u,e,t,i);UU(u)&&(n.syncPointTree_=n.syncPointTree_.remove(l));const m=p.removed;if(d=p.events,!a){const y=m.findIndex(w=>w._queryParams.loadsAllData())!==-1,E=n.syncPointTree_.findOnPath(l,(w,R)=>Bs(R));if(y&&!E){const w=n.syncPointTree_.subtree(l);if(!w.isEmpty()){const R=QU(w);for(let C=0;C<R.length;++C){const B=R[C],j=B.query,$=XI(n,B);n.listenProvider_.startListening(cc(j),Ic(n,j),$.hashFn,$.onComplete)}}}!E&&m.length>0&&!i&&(y?n.listenProvider_.stopListening(cc(e),null):m.forEach(w=>{const R=n.queryToTagMap.get(lp(w));n.listenProvider_.stopListening(cc(w),R)}))}XU(n,m)}return d}function $I(n,e,t,i){const a=lv(n,i);if(a!=null){const l=uv(a),u=l.path,d=l.queryId,p=bn(u,e),m=new Ha(nv(d),p,t);return cv(n,u,m)}else return[]}function YU(n,e,t,i){const a=lv(n,i);if(a){const l=uv(a),u=l.path,d=l.queryId,p=bn(u,e),m=ut.fromObject(t),y=new Rc(nv(d),p,m);return cv(n,u,y)}else return[]}function $U(n,e,t,i=!1){const a=e._path;let l=null,u=!1;n.syncPointTree_.foreachOnPath(a,(w,R)=>{const C=bn(w,a);l=l||Ds(R,C),u=u||Bs(R)});let d=n.syncPointTree_.get(a);d?(u=u||Bs(d),l=l||Ds(d,We())):(d=new zI,n.syncPointTree_=n.syncPointTree_.set(a,d));let p;l!=null?p=!0:(p=!1,l=we.EMPTY_NODE,n.syncPointTree_.subtree(a).foreachChild((R,C)=>{const B=Ds(C,We());B&&(l=l.updateImmediateChild(R,B))}));const m=GI(d,e);if(!m&&!e._queryParams.loadsAllData()){const w=lp(e);oe(!n.queryToTagMap.has(w),"View does not exist, but we have a tag");const R=ZU();n.queryToTagMap.set(w,R),n.tagToQueryMap.set(R,w)}const y=ap(n.pendingWriteTree_,a);let E=jU(d,e,t,y,l,p);if(!m&&!u&&!i){const w=qI(d,e);E=E.concat(JU(n,e,w))}return E}function ov(n,e,t){const a=n.pendingWriteTree_,l=n.syncPointTree_.findOnPath(e,(u,d)=>{const p=bn(u,e),m=Ds(d,p);if(m)return m});return MI(a,e,l,t,!0)}function KU(n,e){const t=e._path;let i=null;n.syncPointTree_.foreachOnPath(t,(m,y)=>{const E=bn(m,t);i=i||Ds(y,E)});let a=n.syncPointTree_.get(t);a?i=i||Ds(a,We()):(a=new zI,n.syncPointTree_=n.syncPointTree_.set(t,a));const l=i!=null,u=l?new zs(i,!0,!1):null,d=ap(n.pendingWriteTree_,e._path),p=BI(a,e,d,l?u.getNode():we.EMPTY_NODE,l);return DU(p)}function Yc(n,e){return KI(e,n.syncPointTree_,null,ap(n.pendingWriteTree_,We()))}function KI(n,e,t,i){if(Ue(n.path))return QI(n,e,t,i);{const a=e.get(We());t==null&&a!=null&&(t=Ds(a,We()));let l=[];const u=je(n.path),d=n.operationForChild(u),p=e.children.get(u);if(p&&d){const m=t?t.getImmediateChild(u):null,y=VI(i,u);l=l.concat(KI(d,p,m,y))}return a&&(l=l.concat(av(a,n,i,t))),l}}function QI(n,e,t,i){const a=e.get(We());t==null&&a!=null&&(t=Ds(a,We()));let l=[];return e.children.inorderTraversal((u,d)=>{const p=t?t.getImmediateChild(u):null,m=VI(i,u),y=n.operationForChild(u);y&&(l=l.concat(QI(y,d,p,m)))}),a&&(l=l.concat(av(a,n,i,t))),l}function XI(n,e){const t=e.query,i=Ic(n,t);return{hashFn:()=>(OU(e)||we.EMPTY_NODE).hash(),onComplete:a=>{if(a==="ok")return i?WU(n,t._path,i):GU(n,t._path);{const l=$3(a,t);return YI(n,t,null,l)}}}}function Ic(n,e){const t=lp(e);return n.queryToTagMap.get(t)}function lp(n){return n._path.toString()+"$"+n._queryIdentifier}function lv(n,e){return n.tagToQueryMap.get(e)}function uv(n){const e=n.indexOf("$");return oe(e!==-1&&e<n.length-1,"Bad queryKey."),{queryId:n.substr(e+1),path:new st(n.substr(0,e))}}function cv(n,e,t){const i=n.syncPointTree_.get(e);oe(i,"Missing sync point for query tag that we're tracking");const a=ap(n.pendingWriteTree_,e);return av(i,t,a,null)}function QU(n){return n.fold((e,t,i)=>{if(t&&Bs(t))return[op(t)];{let a=[];return t&&(a=HI(t)),On(i,(l,u)=>{a=a.concat(u)}),a}})}function cc(n){return n._queryParams.loadsAllData()&&!n._queryParams.isDefault()?new(BU())(n._repo,n._path):n}function XU(n,e){for(let t=0;t<e.length;++t){const i=e[t];if(!i._queryParams.loadsAllData()){const a=lp(i),l=n.queryToTagMap.get(a);n.queryToTagMap.delete(a),n.tagToQueryMap.delete(l)}}}function ZU(){return HU++}function JU(n,e,t){const i=e._path,a=Ic(n,e),l=XI(n,t),u=n.listenProvider_.startListening(cc(e),a,l.hashFn,l.onComplete),d=n.syncPointTree_.subtree(i);if(a)oe(!Bs(d.value),"If we're adding a query, it shouldn't be shadowed");else{const p=d.fold((m,y,E)=>{if(!Ue(m)&&y&&Bs(y))return[op(y).query];{let w=[];return y&&(w=w.concat(HI(y).map(R=>R.query))),On(E,(R,C)=>{w=w.concat(C)}),w}});for(let m=0;m<p.length;++m){const y=p[m];n.listenProvider_.stopListening(cc(y),Ic(n,y))}}return u}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
